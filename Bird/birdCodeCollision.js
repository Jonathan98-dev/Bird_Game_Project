...
function detectCollision(obstacle) {
    ...
    positionObstacle = obstacle.getBoundingClientRect();
      ...
      if    (positionBird.left + 80 < positionObstacle.left + (positionObstacle.width) &&
            positionBird.left + (positionBird.width -50) > positionObstacle.left &&
            positionBird.top + 70 < positionObstacle.top + positionObstacle.height &&
            positionBird.height + positionBird.top -65 > positionObstacle.top) {
